...
- **图片放大** — 点击图片弹出全屏预览
- **完全离线** — 零数据收集、零遥测，隐私友好
- **自动更新** — 发布新版本后自动检测并提示更新

## 自动更新

软件启动后会自动检查 [GitHub Releases](https://github.com/wentao1176/lite-md-viewer/releases) 是否有新版本：

- 有新版本时**后台静默下载**
- 下载完成后弹窗提示「立即重启」或「稍后再说」
- 更新包托管在 GitHub Releases，无需任何额外服务器
